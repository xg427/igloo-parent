...
public interface IHibernateSearchLuceneQueryFactory {
	...
	Query matchAllTermsIfGiven(Analyzer analyzer, String terms, BindingRoot<?, String> binding,
			@SuppressWarnings("unchecked") BindingRoot<?, String> ... otherBindings);

	Query matchAllTermsIfGiven(String terms, BindingRoot<?, String> binding,
			@SuppressWarnings("unchecked") BindingRoot<?, String> ... otherBindings);
	...
	Query matchAutocompleteIfGiven(Analyzer analyzer, String terms, BindingRoot<?, String> binding,
			@SuppressWarnings("unchecked") BindingRoot<?, String> ... otherBindings);

	Query matchAutocompleteIfGiven(String terms, BindingRoot<?, String> binding,
			@SuppressWarnings("unchecked") BindingRoot<?, String> ... otherBindings);
	...
	Query matchFuzzyIfGiven(Analyzer analyzer, String terms, Integer maxEditDistance, BindingRoot<?, String> binding,
			@SuppressWarnings("unchecked") BindingRoot<?, String> ... otherBindings);

	Query matchFuzzyIfGiven(String terms, Integer maxEditDistance, BindingRoot<?, String> binding,
			@SuppressWarnings("unchecked") BindingRoot<?, String> ... otherBindings);
	...
	<P> Query beIncludedIfGiven(QueryBuilder builder, BindingRoot<?, ? extends Collection<P>> binding, P value);
	...
	<P> Query matchOneIfGiven(QueryBuilder builder, BindingRoot<?, P> binding, Collection<? extends P> possibleValues);
	...
	<P> Query matchAllIfGiven(BindingRoot<?, ? extends Collection<P>> binding, Collection<? extends P> possibleValues);

	<P> Query matchAllIfGiven(QueryBuilder builder, BindingRoot<?, ? extends Collection<P>> binding, Collection<? extends P> possibleValues);

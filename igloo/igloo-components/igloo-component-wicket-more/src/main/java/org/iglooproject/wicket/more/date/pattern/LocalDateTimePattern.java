...
public enum LocalDateTimePattern implements ILocalDateTimePattern {
	...
	private LocalDateTimePattern(String javaPatternKey, String javascriptPatternKey) {
		this(javaPatternKey, javascriptPatternKey, false);
	}

	private LocalDateTimePattern(String javaPatternKey, String javascriptPatternKey, boolean capitalize) {

...
public enum ZonedDateTimePattern implements IZonedDateTimePattern {
	...
	private ZonedDateTimePattern(String javaPatternKey, String javascriptPatternKey) {
		this(javaPatternKey, javascriptPatternKey, false);
	}

	private ZonedDateTimePattern(String javaPatternKey, String javascriptPatternKey, boolean capitalize) {

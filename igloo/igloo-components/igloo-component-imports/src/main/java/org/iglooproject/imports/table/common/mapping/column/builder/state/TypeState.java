...
public abstract class TypeState<TTable, TRow, TCell, TCellReference> {
	...
	public static final class DefaultNumericFormatSupplier implements SerializableSupplier2<NumberFormat> {
	...
	protected class TypeStateSwitcher<T> implements ColumnFunctionBuildStateSwitcher<TTable, TRow, TCell, TCellReference, T> {
		...
		public TypeStateSwitcher(Function2<? super TCell , ? extends T> function, Predicate2<? super T> mandatoryValuePredicate) {
			super();
		...
		@Override
		public StringState<TTable, TRow, TCell, TCellReference> toString(final Function2<? super T, String> function) {
		...
		@Override
		public IntegerState<TTable, TRow, TCell, TCellReference> toInteger(Function2<? super T, Integer> function) {
		...
		@Override
		public LongState<TTable, TRow, TCell, TCellReference> toLong(Function2<? super T, Long> function) {
		...
		@Override
		public DoubleState<TTable, TRow, TCell, TCellReference> toDouble(Function2<? super T, Double> function) {
		...
		@Override
		public BigDecimalState<TTable, TRow, TCell, TCellReference> toBigDecimal(Function2<? super T, BigDecimal> function) {
		...
		@Override
		public DateState<TTable, TRow, TCell, TCellReference> toDate(Function2<? super T, ? extends Date> function) {
		...
		@Override
		public BooleanState<TTable, TRow, TCell, TCellReference> toBoolean(Function2<? super T, Boolean> function) {
		...
		@Override
		public <TValue> GenericState<TTable, TRow, TCell, TCellReference, TValue> toGeneric(Function2<? super T, TValue> function) {

...
public interface LocalTimeFunctionBuildState
		<
		TBuildResult,
		...
		>
		extends FunctionBuildState<TBuildResult, LocalTime, TBooleanState, TDateState, TLocalDateTimeState, TLocalDateState, TLocalTimeState, TZonedDateTimeState, TIntegerState, TLongState, TDoubleState, TBigDecimalState, TStringState> {

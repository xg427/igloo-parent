...
public interface BooleanFunctionBuildState
		...
		>
		extends FunctionBuildState<TBuildResult, Boolean, TBooleanState, TDateState, TLocalDateTimeState, TLocalDateState, TLocalTimeState, TZonedDateTimeState, TIntegerState, TLongState, TDoubleState, TBigDecimalState, TStringState> {

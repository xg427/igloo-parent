...
public interface DoubleFunctionBuildState
		...
		>
		extends NumberFunctionBuildState<TBuildResult, Double, TBooleanState, TDateState, TLocalDateTimeState, TLocalDateState, TLocalTimeState, TZonedDateTimeState, TIntegerState, TLongState, TDoubleState, TBigDecimalState, TStringState> {

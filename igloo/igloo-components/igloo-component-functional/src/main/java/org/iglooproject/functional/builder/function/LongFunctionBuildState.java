...
public interface LongFunctionBuildState
		...
		>
		extends NumberFunctionBuildState<TBuildResult, Long, TBooleanState, TDateState, TLocalDateTimeState, TLocalDateState, TLocalTimeState, TZonedDateTimeState, TIntegerState, TLongState, TDoubleState, TBigDecimalState, TStringState> {

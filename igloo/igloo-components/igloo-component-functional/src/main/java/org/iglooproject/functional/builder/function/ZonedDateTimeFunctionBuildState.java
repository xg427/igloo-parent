...
public interface ZonedDateTimeFunctionBuildState
		<
		TBuildResult,
		...
		>
		extends FunctionBuildState<TBuildResult, ZonedDateTime, TBooleanState, TDateState, TLocalDateTimeState, TLocalDateState, TLocalTimeState, TZonedDateTimeState, TIntegerState, TLongState, TDoubleState, TBigDecimalState, TStringState> {

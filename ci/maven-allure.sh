...
echo mvn -fae -Dtest='infinispan/**/*.java' -DfailIfNoTests=false integration-test site:site
mvn -fae -Dtest='infinispan/**/*.java' -DfailIfNoTests=false integration-test site:site
TEST_RESULT=$?
